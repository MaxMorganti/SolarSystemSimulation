...
// Created by: Anthony Maxwell Morganti
// 5-16-2017
//
//  Configured to test the stability of the Trappist-1 exoplanetary system.
//  
//  - Set initial conditions and parameters of objects (distance, mass, velocity) and time interval.
//  - Program incrementally solves the differential equations of motion numerically for each object.
//    using the Euler Algorithm (increment can be changed, default is 2 seconds)
//  - Data for each body is outputted to an individual text file.
//  - A graphing program (such as Gnuplot) can be used to plot the physical configuration of the system
//    at a given time.
//  - Using many closely timed graphs as frames, can create animation of trajectories. (used Gimp).
//
//  ----------------------------------------------------------------------------------------------------
